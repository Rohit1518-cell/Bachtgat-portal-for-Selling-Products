<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin master.master" AutoEventWireup="true" CodeFile="purchase report.aspx.cs" Inherits="Report_purchase_report" %>
    ...
    <table align="center" cellpadding="5" class="style6">
        <tr>
            <td style="text-align: center">
                <strong>Purchase Report</strong></td>
        </tr>
        <tr>
            <td style="text-align: center; font-weight: 700; margin-left: 40px">
