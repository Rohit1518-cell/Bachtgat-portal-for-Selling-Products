<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/Visitor master.master" AutoEventWireup="true" CodeFile="Bachatgat Login.aspx.cs" Inherits="Visitor_Bachatgat_Login" %>
    ...
    <table align="center" cellpadding="5" cellspacing="5" class="" width="90%">
        <tr>
            <td colspan="2" style="font-size: medium">
                &nbsp;<br />
                <br />
                <br /><span class="style12">&nbsp; Login Or Create an Account&nbsp;<br /></span>
            </td>
        </tr>
        <tr>
            <td valign="top">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:Button ID="Button1" runat="server" BackColor="#333333" BorderStyle="None" 
                                ...
                                Text="Sign Up" Width="250px" PostBackUrl="~/Visitor/Registration form.aspx" 
