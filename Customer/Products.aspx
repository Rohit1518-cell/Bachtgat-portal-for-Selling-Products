<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer master.master" AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="Customer_Products" %>
    ...
    <tr>
        <td style="text-align: center" valign="top">
            ...
            <table align="center" cellpadding="5" style="border: thin solid #000000;border-radius:10px" 
                ...
                <tr>
                    <td>
                        <span style="display: inline !important; float: none; background-color: rgb(255, 255, 255); color: rgb(0, 90, 132); font-family: sans-serif,Arial,Verdana,Helvetica; font-size: 125%; font-style: normal; font-variant: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px;">Product Categories -- BUY PRODUCTS HERE &gt;&gt;</span></td>
                </tr>
                <tr>
                    <td>
